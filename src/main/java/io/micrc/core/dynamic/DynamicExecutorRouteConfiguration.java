    ...
    public void configureRoute() throws Exception {
        ...
        from("dynamic-executor://execute")
                ...
                .choice()
                    ...
                    .when(header("executeType").isEqualTo("XPATH"))
                        .setHeader("xml", header("script"))
                        .to("xml-path://content")
                    ...
                    .when(header("executeType").isEqualTo("GENERATE_VERIFY_CODE"))
                        .to("authorize://generateVerifyCode")
                    .when(header("executeType").isEqualTo("COMPARE_VERIFY_CODE"))
