    ...
    public static void main(String[] args) {
        ...
        String s2 =
                "public:Windows:WindowSyncProgressSuccessEvent:orders:Orders:OrderSync#UC-000185\n" +
                        ...
                        "public:PicketTicket:PicketTicketDamageMutationEvent:logistics:Parcels:ParcelsCancleMarkPicketTicket#UC-000291\n" +
                        "public:PicketTicket:PicketTicketInvalidEvent:logistics:Parcels:ParcelsCancleMarkPicketTicket#UC-000291\n" +
                        "public:Invoice:InvoiceGetContentFailureEvent:taxation:Invoice:InvoiceGetContent#UC-000242\n" +
                        "public:Invoice:InvoiceConfirmSubmissionResultFailureEvent:taxation:Invoice:InvoiceConfirmSubmissionResult#UC-000244\n" +
                        "public:TaxationAccount:TaxationAccountCheckRenewalEvent:accounts:TaxationAccount:TaxationAccountAutoRenewal#UC-000304\n" +
                        "public:Parcels:ParcelsMarkPicketTicket:inventory:PicketTicket:PicketTicketAuthorizeComplete#UC-000338\n" +
                        "public:Invoice:InvoiceCheckSuccessEvent:taxation:StoreProductsTaxation:StoreProductsTaxationInit#UC-000086\n" +
                        "public:Invoice:InvoiceCheckSuccessEvent:taxation:Consumers:ConsumersInit#UC-000049\n" +
                        "public:Invoice:InvoiceCheckNeedSubmissionEvent:taxation:Invoice:InvoiceSubmission#UC-000243\n" +
                        "public:::::#\n" +
                        "public:::::#\n" +
                        "public:::::#\n" +
                        "public:::::#\n" +
